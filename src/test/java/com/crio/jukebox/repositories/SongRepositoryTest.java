...
public class SongRepositoryTest {
    ...
    public void setup(){
        ...
        final Artist a2 = new Artist("Beyonce");
        final Artist a3 = new Artist("Taylor swift");
        ...
        final Album album_1 = new Album("Test Album");
        final Song s1 = new Song("1" ,"Shape of you", "Pop", album_1, a1, featureArtists_1);
    ...
    public void saveSong(){
        //Arrange
        final Artist a1 = new Artist("Ed Sheeran");
        final Artist a2 = new Artist("David guetta");
        final Song s4 = new Song("Way To Break My Heart", "Pop", new Album("Test Album"), a1, List.of(a1, a2));

        Song expectedSong = new Song("4", "Way To Break My Heart", "Pop", new Album("Test Album"), a1, List.of(a1, a2));
        //Act
